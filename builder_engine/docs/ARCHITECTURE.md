...
## Renderer Module
El Renderer es un módulo registrado en el Kernel. Consume el Documento y genera un árbol headless común para EDIT, PREVIEW y PUBLIC. La materialización en DOM se realiza mediante adaptadores.
