...
urlpatterns = [
    ...
    path("<int:evento_id>/invitacion/", workspace_views.evento_invitacion, name="k9_evento_invitacion"),
    path("<int:evento_id>/mesas/", workspace_views.evento_mesas, name="k9_evento_mesas"),
    path("<int:evento_id>/actividad/", workspace_views.evento_actividad, name="k9_evento_actividad"),
    ...
    path("<int:evento_id>/expediente/exportar/", workspace_views.evento_exportar_expediente, name="k9_evento_exportar_expediente"),
    path("<int:evento_id>/expediente/purge-ready/", workspace_views.evento_exportar_expediente_purge_ready, name="k9_evento_exportar_expediente_purge_ready"),
    path("<int:evento_id>/expediente/ejecutar-purga/", workspace_views.evento_ejecutar_purga_historica, name="k9_evento_ejecutar_purga_historica"),
    path("<int:evento_id>/expediente/confirmar-respaldo/", workspace_views.evento_confirmar_respaldo_externo, name="k9_evento_confirmar_respaldo_externo"),
    path("<int:evento_id>/expediente/autorizar-purga/", workspace_views.evento_autorizar_purga_historica, name="k9_evento_autorizar_purga_historica"),
