...
export function normalizeDirectVideoSource(value) {
    ...
    // Django MEDIA_URL normalmente entrega rutas relativas al origen,
    // por ejemplo /media/editor_invitaciones/assets/video.mp4.
    // Son válidas para <video src> y no deben convertirse en URL absoluta.
